...
export async function DELETE(
  ...
  try {
    db.connect();
    await Users.findByIdAndUpdate(id, { status: "deleted" });
    ...
    const message = `
      ...
      We are pleased to inform you that your guy exchange account has been DELETED. You can now access the platform.<br><br>
      Welcome back!<br><br>
    ...
    const adminEmailTitle = " User Deleted  Notification";
    const adminEmailMessage = `
      Admin,<br><br>
  
      This is to inform you that ${
        userEmail.split("@")[0]
      } has been deleted from Guy Exchange.
