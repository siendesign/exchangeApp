...
export async function PUT(
  ...
  try {
    db.connect();
    await Users.findByIdAndUpdate(id, { status: "suspended" });
    ...
    const message = `
      ...
      We regret to inform you that your ${
        userEmail.split("@")[0]
      } account has been temporarily suspended due to a violation of our Terms of Service.
    ...
    const adminEmailTitle = " User Suspension Notification";
