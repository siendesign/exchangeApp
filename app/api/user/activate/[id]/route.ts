...
export async function PUT(
  ...
  try {
    db.connect();
    await Users.findByIdAndUpdate(id, { status: "active", role: "user" });
    ...
    const title = "NOTICE: USER REINSTATED";
    const message = `
      Dear [${userEmail.split("@")[0]},<br><br>
      
      We are pleased to inform you that your guy exchange account has been reactivated. You can now access your account and use all platform features as before.<br><br>
      Welcome back!<br><br>
    ...
    const adminEmailTitle = " User reinstatement Notification";
    const adminEmailMessage = `
      Admin,<br><br>
  
      This is to inform you that ${
        userEmail.split("@")[0]
      } has been reinstated to Guy Exchange.
    ...
    await sendMail({
      to: AdminEmail.value,
      name: "",
      subject: `NOTICE: USER REINSTATED`,
      body: `<!--
            * This email was built using Tabular.
            * For more information, visit https://tabular.email
            -->
