import fs, { mkdir, stat, writeFile, readFile } from "fs/promises";
  ...
  try {
    ...
    await sendMail({
      ...
      * For more information, visit https://tabular.email
      ...
      <p class="t4" style="margin:0;Margin:0;font-family:Albert Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:22px;font-weight:500;font-style:normal;font-size:14px;text-decoration:none;text-transform:none;letter-spacing:-0.56px;direction:ltr;color:#333333;text-align:left;mso-line-height-rule:exactly;mso-text-raise:2px;">Your order is being processed by UPS and is on its way to Amsterdam. You will receive an update from us regarding the status of your order and the delivery of the parcel.</p></td>
      </tr></table>
      </td></tr><tr><td>
