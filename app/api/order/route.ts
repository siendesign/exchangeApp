...
export async function POST(req: NextRequest) {
  ...
  await sendMail({
    ...
    * For more information, visit https://tabular.email
    ...
    console.log("notifiying Admin of Order");
  });

  const userTitle = "You've Created a new order";
  const userMessage = "GuyExchange is happy to receive your :)";
  ...
  }).then((res) => console.log("email sent to user"));
