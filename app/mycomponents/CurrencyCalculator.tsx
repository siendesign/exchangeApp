...
const CurrencyCalculator = () => {
  ...
  const handleChangeToValue = (e: any) => {
    ...
    if (focus === "from") {
      ...
      const calculatedToAmount = parseFloat(
        ((1 / rate) * numericValue).toFixed(2)
      );
  ...
  const handlePlaceOrder = async () => {
    console.log("order placed by " + authUser?.user?.email!);
  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-10 w-full">
          ...
          <div className="text-4xl sm:text-7xl grid grid-cols-12 gap-6">
            ...
            <div className="col-span-10">
              <input
                ...
                disabled={from === undefined || to === undefined ? true : false}
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col gap-3">
          <h3 className="uppercase text-md text-gray-500 font-semibold">to</h3>
          <div className="border-b">
            <ToCurrencyDropdown
              from={from}
              setTo={setTo}
      ...
      <div className="flex gap-10 w-full">
          ...
          <Drawer>
            ...
            <DrawerContent className="h-fit">
                ...
                <div className="sm:flex w-full gap-5">
                  ...
                  <div className="flex-grow flex items-start ">
                    <div className="flex w-full flex-col gap-5 justify-center items-center sm:items-start space-x-2 px-5 mt-5">
                      ...
                      <div className="grid w-full max-w-sm items-center gap-1.5">
                        <Label htmlFor="email">Destination Account Name</Label>
                        <Input
                          type="text"
                          placeholder="Enter Destination account number"
              ...
              <DrawerFooter className="sm:flex-row">
                ...
                >
                  {isOrderSending ? "Placing Order ..." : "Place Order"}
                </Button>
                <DrawerClose>
        ...
        <div className="flex-1 flex items-center gap-10">
          <div className="">
            <h3 className="text-sm text-gray-500 capitalize">Exchange Rate</h3>
