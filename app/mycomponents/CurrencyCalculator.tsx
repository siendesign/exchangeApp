        ...
        <div className="flex-1 flex flex-col gap-3">
          ...
          <div className="text-7xl grid grid-cols-12 gap-6">
            ...
            <div className="col-span-10">
              <input type="number" className="w-full h-full" placeholder="0.00" value={fromAmount} step='0.01' onFocus={()=>{setFocus('from')}} onChange={handleChangeToValue}/>
            </div>
          </div>
        </div>

        <div className="flex-1 flex flex-col gap-3">
          <h3 className="capitalize text-sm text-gray-500 font-semibold">to</h3>
          <div className="border-b">
